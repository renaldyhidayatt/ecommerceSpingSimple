...
public class OrderService {
    ...
    @Autowired
    public OrderService(OrderRepository orderRepository, AuthService authService, ProductRepository productRepository,
            OrderitemRepository orderitemRepository, OrderToDto orderToDto) {
    ...
    public OrderResponse createOrder(OrderRequest request) {
        ...
        _order.setUser(this.authService.getCurrentUser());
