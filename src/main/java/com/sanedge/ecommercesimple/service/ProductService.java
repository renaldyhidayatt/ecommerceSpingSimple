...
public class ProductService {
    ...
    public ProductService(ProductRepository productRepository, FileStorageService fileStorageService,
            CategoryRepository categoryRepository, ProductToDto productToDto) {
    ...
    public Product updateById(long id, ProductRequest productRequest, MultipartFile file) {
        ...
        this.fileStorageService.deleteByName(_product.getImage());
    ...
    public MessageResponse delete(long id) {
        ...
        this.fileStorageService.deleteByName(_product.getImage());
        this.fileStorageService.deleteByNames(_product.getImages());
